...
def add_user_to_channel(client: TelegramClient, user: types.User, channel) -> bool:
    ...
    if users:
        ...
        try:
            ...
            status = f"Espere por {e.seconds} segundos. Pulando!"
...
if __name__ == '__main__':
    ...
    try:
            ...
            for api in api_info_list:
                ...
                for unparsed_phone in phone_list:
                    ...
                    if not channels_joined:
                        print_output(client, status="Erro de Permissão")
                        continue
                    ...
                    while user_rows:
                        ...
                        if not user:
                            print_output(client, to_channel, status="Usuário não encontrado")
                            continue
        ...
        print("Adicionado!" if done else "Erro!")